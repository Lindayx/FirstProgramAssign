...
export default function AddNewPet() {
    ...
    const onSubmit=()=>{
        ...
        if(Object.keys(formData).length!=8){
            Alert.alert( // ToastAndroid not working on iOS
                "Error",
        ...
        setLoader(true);
        // UploadImage(); // Skipped and replaced with SaveFormData
        SaveFormData();
    }

    // There should be a storage function here for the image uploaded
    // since storage is not free on firebase, we skip it for now

    const SaveFormData = async()=>{
        const docId=Date.now().toString();
        await setDoc(doc(db, 'Pets', docId), {
            ...formData,
            imageUrl: 'https://cdn-icons-png.flaticon.com/512/3460/3460335.png', // dummy url
